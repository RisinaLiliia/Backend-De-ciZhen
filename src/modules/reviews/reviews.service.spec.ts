...
describe('ReviewsService', () => {
  ...
  it('getSummaryByTarget returns aggregate totals/distribution', async () => {
    ...
    const res = await service.getSummaryByTarget('u1', 'provider');
  ...
  it('getSummaryByTarget returns zeroed summary when no reviews found', async () => {
