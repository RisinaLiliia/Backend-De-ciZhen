...
@Module({
  ...
  providers: [WorkspaceService, WorkspaceRequestSnapshotsService, WorkspaceRequestsService, WorkspacePublicOverviewService, WorkspacePrivateOverviewService, WorkspaceStatisticsService, InsightsService],
})
